...
We are two equally-skilled professionals collaborating on our tasks.
...
- **Evidence**: Provide links where it makes sense to support and backup your assertions
...
- **The preferred Python package manager is "Poetry".** Use it to create virtualenvs, install dependencies, create packages, and so forth. But if a codebase is using a different package manager, use that package manager.
